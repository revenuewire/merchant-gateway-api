...
class PaymentMethod implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["NOT_ACTIVATED", "ACTIVATED", "DISABLED"];
        if (!in_array($this->container['status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status', must be one of 'NOT_ACTIVATED', 'ACTIVATED', 'DISABLED'.";
        }
    ...
    {
        $allowed_values = array('NOT_ACTIVATED', 'ACTIVATED', 'DISABLED');
        if (!is_null($status) && (!in_array($status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'NOT_ACTIVATED', 'ACTIVATED', 'DISABLED'");
        }
